...
// gulp.task('prepare', ['setOptions:prepare', global.gulpOptions.prefix + 'build'], 'cp');

// gulp.task('prepareLiteUgly', ['setOptions:prepareUgly', global.gulpOptions.prefix + 'build'], 'cp');

// gulp.task('prepareUgly', ['setOptions:prepare', 'setOptions:prepareUgly', global.gulpOptions.prefix + 'build'], 'cp');
